...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(WOW) {/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/home */ "./src/js/modules/home.js");
/* harmony import */ var _modules_specialities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/specialities */ "./src/js/modules/specialities.js");
/* harmony import */ var _modules_contacts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/contacts */ "./src/js/modules/contacts.js");
/* harmony import */ var _modules_thinking__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/thinking */ "./src/js/modules/thinking.js");
/* harmony import */ var _modules_about__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/about */ "./src/js/modules/about.js");
/* harmony import */ var _modules_careers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/careers */ "./src/js/modules/careers.js");
...
var app = {
  init: function init() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav_button').click(function (e) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').toggleClass('menu--active');
    });
    ...
    var page = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').attr('class'); //Scrollbar.init(document.querySelector('#main-scroll'))
    ...
    switch (page) {
      ...
      case 'specialities':
        Object(_modules_specialities__WEBPACK_IMPORTED_MODULE_2__["default"])();
        break;
      ...
      case 'thinking':
        Object(_modules_thinking__WEBPACK_IMPORTED_MODULE_4__["default"])();
        break;

      case 'about':
        Object(_modules_about__WEBPACK_IMPORTED_MODULE_5__["default"])();
        break;

      case 'careers':
        Object(_modules_careers__WEBPACK_IMPORTED_MODULE_6__["default"])();
        break;
...
app.init();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! wowjs */ "./node_modules/wowjs/dist/wow.js")))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return thinking; });
function thinking() {
  ...
  $('.dropdown__list li:not(.sub)').click(function () {
    ...
    $('.about__team_filters .dropdown').each(function (i, el) {
      var plaeceholder = $(el).find('.current').attr('data-placeholder');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return contacts; });
...
function contacts() {
  ...
  var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#careers-hero-slider', {
    // Optional parameters
    loop: true,
...
function contacts() {
  ...
  GoogleMapsLoader.load(function (google) {
    ...
    var marker1 = new google.maps.Marker({
      icon: image,
      position: myLatLng1,
      map: map //title: 'ул.Спасская, 25, г. Вышгород'
...
function home() {
  ...
  var homeTopSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.home__main-slider .swiper-container', {
    navigation: {
    ...
    pagination: {
      ...
      type: 'fraction',
      formatFractionCurrent: function formatFractionCurrent(current) {
        return current < 10 ? '0' + current : current;
      },
      formatFractionTotal: function formatFractionTotal(total) {
        return total < 10 ? '0' + total : total;
      }
    },
    slidesPerView: 1,
    speed: 700 //watchOverflow : true
    //spaceBetween: 1
  ...
  GoogleMapsLoader.load(function (google) {
    //var center = (page == 'home' ? {lat: -40.971740, lng: 180.760507} : {lat: -40.971740, lng: 174.760507})
    var center = window.innerWidth > 900 ? {
      lat: -40.971740,
      lng: 180.760507
    } : {
      lat: -39.971740,
...
/***/ "./src/js/modules/specialities.js":
/*!****************************************!*\
  !*** ./src/js/modules/specialities.js ***!
  \****************************************/
/*! exports provided: default */
...
function specialities() {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).width() > 900) {// specialtiesList = new Swiper('#home-specialties-slider', {
    //   slidesPerView: 4,
    //   navigation: {
    //     nextEl: '#home-specialties-slider .home__main-slider_navigation--arrows .arrow-next',
    //     prevEl: '#home-specialties-slider .home__main-slider_navigation--arrows .arrow-prev',
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).resize(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).width() > 900) {
      if (specialtiesList) {
        specialtiesList.destroy();
        specialtiesList = null;
      }
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').is(':visible')) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').fadeOut(300, function () {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').removeClass('no-scroll');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').removeClass('modal-show');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').show();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').show();
      });
    }
  }); // Modal events

  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').click(function (e) {
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).hasClass('modal__close') || jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).hasClass('modal__scroll')) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.currentTarget).fadeOut(300, function () {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').removeClass('no-scroll');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.currentTarget).removeClass('modal-show');
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').show();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.currentTarget).show();
      });
    }
  });
  var modalSwiper;
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.home__specialties_list--item').click(function (e) {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal__expertise').length) {
      if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal__expertise .swiper-slide').length < 4) jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal__expertise_prev, .modal__expertise_next').hide();
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__article').length) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__article').removeAttr('style');
      var summ = 0;
      var h = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__article').height() / 2;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__article > *').each(function (i, el) {
        if (summ > h) return;
        summ += jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).height() + 30;
      });
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__article').height(summ);
    }

    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions').length) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').removeAttr('style');
      var _summ = 0;

      var _h = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').height() / 2;

      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul li').each(function (i, el) {
        if (_summ > _h) return;
        _summ += jquery__WEBPACK_IMPORTED_MODULE_1___default()(el).height() + 30;
      });
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').height(_summ);
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').hide();
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal__transactions.open').removeClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions').unbind('click');
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions').click(function (e) {
        if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').is(':hidden')) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions').addClass('open');
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').fadeIn(300);
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions').removeClass('open');
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-specialties .modal__transactions ul').fadeOut(300);
        }
      });
    }
...
/* harmony import */ var air_datepicker_dist_js_i18n_datepicker_en_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! air-datepicker/dist/js/i18n/datepicker.en.js */ "./node_modules/air-datepicker/dist/js/i18n/datepicker.en.js");
/* harmony import */ var air_datepicker_dist_js_i18n_datepicker_en_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(air_datepicker_dist_js_i18n_datepicker_en_js__WEBPACK_IMPORTED_MODULE_1__);
